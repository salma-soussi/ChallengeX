    ...
    <div className="flex  justify-start relative  m-0">
      ...
      <div className="flex flex-col p-2 relative mt-12 bg-gray-100 mr-10 rounded-lg  w-full pl-20">
        ...
        >
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                >
                  ...
                  <option value="dog">Design</option>
                  <option value="cat">Algorithm</option>
                </select>
              </div>
              <div className="col-span-full sm:col-span-3">
          ...
          <button
            type="button"
            className="py-2 px-4 flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg self-end"
          >
            <svg
          ...
          <button
            type="button"
            className="py-2 px-4 flex justify-center items-center  bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg self-end"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-2"
