...
export default function SideBarExtended(props) {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-gray-800 h-fit w-52 relative">
      <div className="h-screen bg-white dark:bg-gray-800  fixed left-0 top-0 bottom-0 shadow-md">
        <LogoExtended
          image="https://source.unsplash.com/random/360x480"
          name="Alex John"
        />
        <nav className="mt-10 px-5 ">{elements}</nav>
      </div>
      <div className="fixed bottom-0 mb-4">
        ...
        >
          ...
          <span className="mx-4 font-semibold">Hide</span>
        </button>
      </div>
    </div>
  );
